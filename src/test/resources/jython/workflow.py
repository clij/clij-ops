...
scaled = ops.run("CLIJ_downsample", positiveStack, sampleX, sampleY, sampleZ)
reslicedFromTop = ops.run("CLIJ_resliceTop", scaled)
radialResliced = ops.run("CLIJ_radialProjection", reslicedFromTop, 360, 1.0)
reslicedFromLeft = ops.run("CLIJ_resliceLeft", radialResliced)
maxProjected = ops.run("CLIJ_maximumZProjection", reslicedFromLeft)
