...
import net.haesleinhuepf.clij.ops.CLIJ_copy.CLIJ_copy;
...
public class RotateOverwriteOriginal {
	...
	public void run() throws IOException {
		...
		ij.ui().show("rotated (overwriting original)", result);
	...
	public static void main(String... args) throws IOException {
		RotateOverwriteOriginal task = new RotateOverwriteOriginal();
		task.run();
	}
}
