...
public class BinaryHybridCFProperties extends HybridCFProperties {
	...
	public BinaryHybridCFProperties(String line, String namespace,
		String header)
	{
	...
	public String getClassName() {
		String src1Class = getParameterClass(getParameter(parameters,
			src1Parameter));
		String src2Class = getParameterClass(getParameter(parameters,
			src2Parameter));
	...
	public String build() {
		...
		builder.append("        AbstractBinaryHybridCF<" + srcClass + ", " +
			src1Class + ", " + dstClass + ">\n");
		builder.append("        implements " + getOpDep(namespaceClass) +
			", Contingent\n");
		builder.append("{\n\n");
		for (String parameter : parameters) {
			builder.append(buildParameter(parameter, src1Parameter, src2Parameter,
				dstParameter));
		}
		builder.append("    @Override\n");
		builder.append("    public void compute(final " + srcClass +
			" input1, final " + src1Class + " input2, final " + dstClass +
			" output)\n");
		builder.append("    {\n");
