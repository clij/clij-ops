 ...
 * <p>
 * <p>
 * Author: @frauzufall 01 2019
 */
public class OpGenerator {

	static String root =
		"/home/random/Development/imagej/project/clij/clij-ops/src/main/java/net/haesleinhuepf/clij/ops/generated/";
	...
	public static void main(String... args) throws IOException {
		...
		File inputFile = new File(
			"/home/random/Development/imagej/project/clij/clij-core/src/main/java/net/haesleinhuepf/clij/kernels/Kernels.java");
		...
		for (int i = 0; i < methods.size(); i++) {
			...
			for (int j = 0; j < methodCount; j++) {
				if (processKernelFunction(header, namespace, methods.get(i + j)))
					opCreated++;
				else opNotCreated++;
			}
			i += methodCount - 1;
		...
		System.out.println(methods.size() + " kernel functions available, " +
			opCreated + " ops created, " + opNotCreated + " kernel functions failed");
	...
	private static List<String> locateMethods(BufferedReader br)
		throws IOException
	{
		List<String> res = new ArrayList<>();
		String line;
	...
	private static boolean processKernelFunction(String header, String namespace,
		String line) throws IOException
	{
		...
		else if (!params.contains("src") && params.contains("src1") && params
			.contains("dst"))
		{
		...
		else if (params.contains("subtrahend") && params.contains("minuend") &&
		...
		else if (params.contains("source1") && params.contains("source2") && params
