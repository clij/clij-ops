package net.haesleinhuepf.clij.ops.generated.blurIJCLIJ;
...
public class BlurIJCLIJCClearCLBufferClearCLBuffer
        extends
        AbstractUnaryComputerOp<ClearCLBuffer,ClearCLBuffer>
        implements BlurIJCLIJ, Contingent
{
    ...
    public void compute(final ClearCLBuffer input, final ClearCLBuffer output)
    {
        final CLIJ clij = CLIJ.getInstance();
            ...
            Kernels.blurIJ(clij, input, output, sigma);
    }
