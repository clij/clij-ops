package net.haesleinhuepf.clij.ops.generated.binaryOrCLIJ;
...
public class BinaryOrCLIJCClearCLBufferClearCLBufferClearCLBuffer
        extends
        AbstractBinaryComputerOp<ClearCLBuffer, ClearCLBuffer, ClearCLBuffer>
        implements BinaryOrCLIJ, Contingent
{
    ...
    public void compute(final ClearCLBuffer input1, final ClearCLBuffer input2, final ClearCLBuffer output)
    {
        ...
        Kernels.binaryOr(clij, input1, input2, output);
    }
