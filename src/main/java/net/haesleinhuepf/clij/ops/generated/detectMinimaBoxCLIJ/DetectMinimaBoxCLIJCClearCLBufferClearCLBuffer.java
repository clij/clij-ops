package net.haesleinhuepf.clij.ops.generated.detectMinimaBoxCLIJ;
...
public class DetectMinimaBoxCLIJCClearCLBufferClearCLBuffer
        extends
        AbstractUnaryComputerOp<ClearCLBuffer,ClearCLBuffer>
        implements DetectMinimaBoxCLIJ, Contingent
{
    ...
    public void compute(final ClearCLBuffer input, final ClearCLBuffer output)
    {
        final CLIJ clij = CLIJ.getInstance();
            ...
            Kernels.detectMinimaBox(clij, input, output, radius);
    }
