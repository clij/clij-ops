package net.haesleinhuepf.clij.ops.generated.sumZProjectionCLIJ;
...
public class SumZProjectionCLIJCClearCLBufferClearCLBuffer
        extends
        AbstractUnaryComputerOp<ClearCLBuffer,ClearCLBuffer>
        implements SumZProjectionCLIJ, Contingent
{
    ...
    public void compute(final ClearCLBuffer input, final ClearCLBuffer output)
    {
        final CLIJ clij = CLIJ.getInstance();
            ...
            Kernels.sumZProjection(clij, input, output);
    }
