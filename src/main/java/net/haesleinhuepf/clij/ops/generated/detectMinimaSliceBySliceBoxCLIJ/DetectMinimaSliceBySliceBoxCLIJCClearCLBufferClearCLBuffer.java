package net.haesleinhuepf.clij.ops.generated.detectMinimaSliceBySliceBoxCLIJ;
...
public class DetectMinimaSliceBySliceBoxCLIJCClearCLBufferClearCLBuffer
        extends
        AbstractUnaryComputerOp<ClearCLBuffer,ClearCLBuffer>
        implements DetectMinimaSliceBySliceBoxCLIJ, Contingent
{
    ...
    public void compute(final ClearCLBuffer input, final ClearCLBuffer output)
    {
        final CLIJ clij = CLIJ.getInstance();
            ...
            Kernels.detectMinimaSliceBySliceBox(clij, input, output, radius);
    }
