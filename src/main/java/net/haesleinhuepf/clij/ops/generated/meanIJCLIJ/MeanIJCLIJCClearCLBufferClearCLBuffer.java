package net.haesleinhuepf.clij.ops.generated.meanIJCLIJ;
...
public class MeanIJCLIJCClearCLBufferClearCLBuffer
        extends
        AbstractUnaryComputerOp<ClearCLBuffer,ClearCLBuffer>
        implements MeanIJCLIJ, Contingent
{
    ...
    public void compute(final ClearCLBuffer input, final ClearCLBuffer output)
    {
        final CLIJ clij = CLIJ.getInstance();
            ...
            Kernels.meanIJ(clij, input, output, radius);
    }
