package net.haesleinhuepf.clij.ops.generated.powerCLIJ;
...
public class PowerCLIJCClearCLBufferClearCLBuffer
        extends
        AbstractUnaryComputerOp<ClearCLBuffer,ClearCLBuffer>
        implements PowerCLIJ, Contingent
{
    ...
    public void compute(final ClearCLBuffer input, final ClearCLBuffer output)
    {
        final CLIJ clij = CLIJ.getInstance();
            ...
            Kernels.power(clij, input, output, exponent);
    }
