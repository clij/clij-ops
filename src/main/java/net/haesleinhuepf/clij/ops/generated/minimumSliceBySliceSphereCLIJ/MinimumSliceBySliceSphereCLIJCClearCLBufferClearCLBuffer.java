package net.haesleinhuepf.clij.ops.generated.minimumSliceBySliceSphereCLIJ;
...
public class MinimumSliceBySliceSphereCLIJCClearCLBufferClearCLBuffer
        extends
        AbstractUnaryComputerOp<ClearCLBuffer,ClearCLBuffer>
        implements MinimumSliceBySliceSphereCLIJ, Contingent
{
    ...
    public void compute(final ClearCLBuffer input, final ClearCLBuffer output)
    {
        final CLIJ clij = CLIJ.getInstance();
            ...
            Kernels.minimumSliceBySliceSphere(clij, input, output, kernelSizeX, kernelSizeY);
    }
