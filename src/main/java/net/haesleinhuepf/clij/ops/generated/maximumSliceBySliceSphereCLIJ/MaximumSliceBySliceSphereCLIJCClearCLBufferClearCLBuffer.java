package net.haesleinhuepf.clij.ops.generated.maximumSliceBySliceSphereCLIJ;
...
public class MaximumSliceBySliceSphereCLIJCClearCLBufferClearCLBuffer
        extends
        AbstractUnaryComputerOp<ClearCLBuffer,ClearCLBuffer>
        implements MaximumSliceBySliceSphereCLIJ, Contingent
{
    ...
    public void compute(final ClearCLBuffer input, final ClearCLBuffer output)
    {
        final CLIJ clij = CLIJ.getInstance();
            ...
            Kernels.maximumSliceBySliceSphere(clij, input, output, kernelSizeX, kernelSizeY);
    }
