package net.haesleinhuepf.clij.ops.generated.binaryNotCLIJ;
...
public class BinaryNotCLIJCClearCLBufferClearCLBuffer
        extends
        AbstractUnaryComputerOp<ClearCLBuffer,ClearCLBuffer>
        implements BinaryNotCLIJ, Contingent
{
    ...
    public void compute(final ClearCLBuffer input, final ClearCLBuffer output)
    {
        final CLIJ clij = CLIJ.getInstance();
            ...
            Kernels.binaryNot(clij, input, output);
    }
