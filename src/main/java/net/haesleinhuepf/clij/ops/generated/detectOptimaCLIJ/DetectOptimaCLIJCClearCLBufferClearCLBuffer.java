package net.haesleinhuepf.clij.ops.generated.detectOptimaCLIJ;
...
public class DetectOptimaCLIJCClearCLBufferClearCLBuffer
        extends
        AbstractUnaryComputerOp<ClearCLBuffer,ClearCLBuffer>
        implements DetectOptimaCLIJ, Contingent
{
    ...
    public void compute(final ClearCLBuffer input, final ClearCLBuffer output)
    {
        final CLIJ clij = CLIJ.getInstance();
            ...
            Kernels.detectOptima(clij, input, output, radius, detectMaxima);
    }
