package net.haesleinhuepf.clij.ops.generated.meanZProjectionCLIJ;
...
public class MeanZProjectionCLIJCClearCLBufferClearCLBuffer
        extends
        AbstractUnaryComputerOp<ClearCLBuffer,ClearCLBuffer>
        implements MeanZProjectionCLIJ, Contingent
{
    ...
    public void compute(final ClearCLBuffer input, final ClearCLBuffer output)
    {
        final CLIJ clij = CLIJ.getInstance();
            ...
            Kernels.meanZProjection(clij, input, output);
    }
