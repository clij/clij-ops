package net.haesleinhuepf.clij.ops.generated.argMaximumZProjectionCLIJ;
...
public class ArgMaximumZProjectionCLIJCClearCLBufferClearCLBuffer
        extends
        AbstractUnaryComputerOp<ClearCLBuffer,ClearCLBuffer>
        implements ArgMaximumZProjectionCLIJ, Contingent
{
    ...
    public void compute(final ClearCLBuffer input, final ClearCLBuffer output)
    {
        final CLIJ clij = CLIJ.getInstance();
            ...
            Kernels.argMaximumZProjection(clij, input, output, dst_arg);
    }
