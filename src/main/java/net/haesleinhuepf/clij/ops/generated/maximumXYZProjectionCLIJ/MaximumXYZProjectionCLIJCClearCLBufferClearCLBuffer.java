package net.haesleinhuepf.clij.ops.generated.maximumXYZProjectionCLIJ;
...
public class MaximumXYZProjectionCLIJCClearCLBufferClearCLBuffer
        extends
        AbstractUnaryComputerOp<ClearCLBuffer,ClearCLBuffer>
        implements MaximumXYZProjectionCLIJ, Contingent
{
    ...
    public void compute(final ClearCLBuffer input, final ClearCLBuffer output)
    {
        final CLIJ clij = CLIJ.getInstance();
            ...
            Kernels.maximumXYZProjection(clij, input, output, projectedDimensionX, projectedDimensionY, projectedDimension);
    }
