package net.haesleinhuepf.clij.ops.generated.rotateLeftCLIJ;
...
public class RotateLeftCLIJCClearCLBufferClearCLBuffer
        extends
        AbstractUnaryComputerOp<ClearCLBuffer,ClearCLBuffer>
        implements RotateLeftCLIJ, Contingent
{
    ...
    public void compute(final ClearCLBuffer input, final ClearCLBuffer output)
    {
        final CLIJ clij = CLIJ.getInstance();
            ...
            Kernels.rotateLeft(clij, input, output);
    }
