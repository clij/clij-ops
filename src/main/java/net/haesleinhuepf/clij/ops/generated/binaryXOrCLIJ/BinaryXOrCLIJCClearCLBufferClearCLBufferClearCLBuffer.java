package net.haesleinhuepf.clij.ops.generated.binaryXOrCLIJ;
...
public class BinaryXOrCLIJCClearCLBufferClearCLBufferClearCLBuffer
        extends
        AbstractBinaryComputerOp<ClearCLBuffer, ClearCLBuffer, ClearCLBuffer>
        implements BinaryXOrCLIJ, Contingent
{
    ...
    public void compute(final ClearCLBuffer input1, final ClearCLBuffer input2, final ClearCLBuffer output)
    {
        ...
        Kernels.binaryXOr(clij, input1, input2, output);
    }
