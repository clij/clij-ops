package net.haesleinhuepf.clij.ops.generated.localThresholdCLIJ;
...
public class LocalThresholdCLIJCClearCLBufferClearCLBuffer
        extends
        AbstractUnaryComputerOp<ClearCLBuffer,ClearCLBuffer>
        implements LocalThresholdCLIJ, Contingent
{

    @Parameter
    private ClearCLBuffer threshold;
    ...
    public void compute(final ClearCLBuffer input, final ClearCLBuffer output)
    {
        final CLIJ clij = CLIJ.getInstance();
            ...
            Kernels.localThreshold(clij, input, output, threshold);
    }
