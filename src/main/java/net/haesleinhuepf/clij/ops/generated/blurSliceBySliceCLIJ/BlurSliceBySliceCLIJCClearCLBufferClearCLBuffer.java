package net.haesleinhuepf.clij.ops.generated.blurSliceBySliceCLIJ;
...
public class BlurSliceBySliceCLIJCClearCLBufferClearCLBuffer
        extends
        AbstractUnaryComputerOp<ClearCLBuffer,ClearCLBuffer>
        implements BlurSliceBySliceCLIJ, Contingent
{
    ...
    public void compute(final ClearCLBuffer input, final ClearCLBuffer output)
    {
        final CLIJ clij = CLIJ.getInstance();
            ...
            Kernels.blurSliceBySlice(clij, input, output, kernelSizeX, kernelSizeY, sigmaX, sigmaY);
    }
