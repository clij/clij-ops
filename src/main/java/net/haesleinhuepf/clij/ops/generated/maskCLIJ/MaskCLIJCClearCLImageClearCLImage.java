package net.haesleinhuepf.clij.ops.generated.maskCLIJ;
...
public class MaskCLIJCClearCLImageClearCLImage
        extends
        AbstractUnaryComputerOp<ClearCLImage,ClearCLImage>
        implements MaskCLIJ, Contingent
{

    @Parameter
    private ClearCLImage mask;
    ...
    public void compute(final ClearCLImage input, final ClearCLImage output)
    {
        final CLIJ clij = CLIJ.getInstance();
            ...
            Kernels.mask(clij, input, mask, output);
    }
