package net.haesleinhuepf.clij.ops.generated.rotateRightCLIJ;
...
public class RotateRightCLIJCClearCLBufferClearCLBuffer
        extends
        AbstractUnaryComputerOp<ClearCLBuffer,ClearCLBuffer>
        implements RotateRightCLIJ, Contingent
{
    ...
    public void compute(final ClearCLBuffer input, final ClearCLBuffer output)
    {
        final CLIJ clij = CLIJ.getInstance();
            ...
            Kernels.rotateRight(clij, input, output);
    }
