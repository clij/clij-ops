package net.haesleinhuepf.clij.ops.generated.medianSliceBySliceSphereCLIJ;
...
public class MedianSliceBySliceSphereCLIJCClearCLBufferClearCLBuffer
        extends
        AbstractUnaryComputerOp<ClearCLBuffer,ClearCLBuffer>
        implements MedianSliceBySliceSphereCLIJ, Contingent
{
    ...
    public void compute(final ClearCLBuffer input, final ClearCLBuffer output)
    {
        final CLIJ clij = CLIJ.getInstance();
            ...
            Kernels.medianSliceBySliceSphere(clij, input, output, kernelSizeX, kernelSizeY);
    }
