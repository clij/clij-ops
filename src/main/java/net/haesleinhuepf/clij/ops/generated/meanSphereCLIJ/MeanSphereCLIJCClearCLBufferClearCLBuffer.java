package net.haesleinhuepf.clij.ops.generated.meanSphereCLIJ;
...
public class MeanSphereCLIJCClearCLBufferClearCLBuffer
        extends
        AbstractUnaryComputerOp<ClearCLBuffer,ClearCLBuffer>
        implements MeanSphereCLIJ, Contingent
{
    ...
    public void compute(final ClearCLBuffer input, final ClearCLBuffer output)
    {
        final CLIJ clij = CLIJ.getInstance();
            ...
            Kernels.meanSphere(clij, input, output, kernelSizeX, kernelSizeY, kernelSizeZ);
    }
