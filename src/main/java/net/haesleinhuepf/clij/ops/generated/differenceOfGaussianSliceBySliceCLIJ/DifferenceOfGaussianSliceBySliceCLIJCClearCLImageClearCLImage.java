package net.haesleinhuepf.clij.ops.generated.differenceOfGaussianSliceBySliceCLIJ;
...
public class DifferenceOfGaussianSliceBySliceCLIJCClearCLImageClearCLImage
        extends
        AbstractUnaryComputerOp<ClearCLImage,ClearCLImage>
        implements DifferenceOfGaussianSliceBySliceCLIJ, Contingent
{
    ...
    @Parameter
    private Float sigmaMinuend;

    @Parameter
    private Float sigmaSubtrahend;
    ...
    public void compute(final ClearCLImage input, final ClearCLImage output)
    {
        final CLIJ clij = CLIJ.getInstance();
            ...
            Kernels.differenceOfGaussianSliceBySlice(clij, input, output, radius, sigmaMinuend, sigmaSubtrahend);
    }
