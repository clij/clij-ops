...
public class DetectMaximaSliceBySliceBoxCLIJCClearCLBufferClearCLBuffer
        extends
        AbstractUnaryComputerOp<ClearCLBuffer,ClearCLBuffer>
        implements DetectMaximaSliceBySliceBoxCLIJ, Contingent
{
    ...
    public void compute(final ClearCLBuffer input, final ClearCLBuffer output)
    {
        final CLIJ clij = CLIJ.getInstance();
            ...
            Kernels.detectMaximaSliceBySliceBox(clij, input, output, radius);
    }
