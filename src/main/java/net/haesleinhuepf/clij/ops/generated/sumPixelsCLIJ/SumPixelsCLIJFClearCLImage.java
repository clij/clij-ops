package net.haesleinhuepf.clij.ops.generated.sumPixelsCLIJ;
...
public class SumPixelsCLIJFClearCLImage
        extends
        AbstractUnaryFunctionOp<ClearCLImage, Double>
        implements SumPixelsCLIJ, Contingent
{
    ...
    public Double calculate(final ClearCLImage input)
    {
        final CLIJ clij = CLIJ.getInstance();
            ...
            return Kernels.sumPixels(clij, input);
    }
