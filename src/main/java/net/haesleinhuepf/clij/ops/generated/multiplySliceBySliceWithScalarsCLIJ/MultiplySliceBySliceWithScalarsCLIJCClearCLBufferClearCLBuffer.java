package net.haesleinhuepf.clij.ops.generated.multiplySliceBySliceWithScalarsCLIJ;
...
public class MultiplySliceBySliceWithScalarsCLIJCClearCLBufferClearCLBuffer
        extends
        AbstractUnaryComputerOp<ClearCLBuffer,ClearCLBuffer>
        implements MultiplySliceBySliceWithScalarsCLIJ, Contingent
{
    ...
    public void compute(final ClearCLBuffer input, final ClearCLBuffer output)
    {
        final CLIJ clij = CLIJ.getInstance();
            ...
            Kernels.multiplySliceBySliceWithScalars(clij, input, output, scalars);
    }
