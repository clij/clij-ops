package net.haesleinhuepf.clij.ops.generated.maximumImagesCLIJ;
...
public class MaximumImagesCLIJCClearCLBufferClearCLBufferClearCLBuffer
        extends
        AbstractBinaryComputerOp<ClearCLBuffer, ClearCLBuffer, ClearCLBuffer>
        implements MaximumImagesCLIJ, Contingent
{
    ...
    public void compute(final ClearCLBuffer input1, final ClearCLBuffer input2, final ClearCLBuffer output)
    {
        ...
        Kernels.maximumImages(clij, input1, input2, output);
    }
