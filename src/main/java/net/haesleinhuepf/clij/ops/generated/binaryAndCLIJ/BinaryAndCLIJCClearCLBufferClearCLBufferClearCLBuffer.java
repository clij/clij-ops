package net.haesleinhuepf.clij.ops.generated.binaryAndCLIJ;
...
public class BinaryAndCLIJCClearCLBufferClearCLBufferClearCLBuffer
        extends
        AbstractBinaryComputerOp<ClearCLBuffer, ClearCLBuffer, ClearCLBuffer>
        implements BinaryAndCLIJ, Contingent
{
    ...
    public void compute(final ClearCLBuffer input1, final ClearCLBuffer input2, final ClearCLBuffer output)
    {
        ...
        Kernels.binaryAnd(clij, input1, input2, output);
    }
