package net.haesleinhuepf.clij.ops.generated.meanSliceBySliceSphereCLIJ;
...
public class MeanSliceBySliceSphereCLIJCClearCLBufferClearCLBuffer
        extends
        AbstractUnaryComputerOp<ClearCLBuffer,ClearCLBuffer>
        implements MeanSliceBySliceSphereCLIJ, Contingent
{
    ...
    public void compute(final ClearCLBuffer input, final ClearCLBuffer output)
    {
        final CLIJ clij = CLIJ.getInstance();
            ...
            Kernels.meanSliceBySliceSphere(clij, input, output, kernelSizeX, kernelSizeY);
    }
