package net.haesleinhuepf.clij.ops.generated.differenceOfGaussianCLIJ;
...
public class DifferenceOfGaussianCLIJCClearCLImageClearCLImage
        extends
        AbstractUnaryComputerOp<ClearCLImage,ClearCLImage>
        implements DifferenceOfGaussianCLIJ, Contingent
{
    ...
    public void compute(final ClearCLImage input, final ClearCLImage output)
    {
        final CLIJ clij = CLIJ.getInstance();
            ...
            Kernels.differenceOfGaussian(clij, input, output, radius, sigmaMinuend, sigmaSubtrahend);
    }
