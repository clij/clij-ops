package net.haesleinhuepf.clij.ops.generated.detectMaximaBoxCLIJ;
...
public class DetectMaximaBoxCLIJCClearCLBufferClearCLBuffer
        extends
        AbstractUnaryComputerOp<ClearCLBuffer,ClearCLBuffer>
        implements DetectMaximaBoxCLIJ, Contingent
{
    ...
    public void compute(final ClearCLBuffer input, final ClearCLBuffer output)
    {
        final CLIJ clij = CLIJ.getInstance();
            ...
            Kernels.detectMaximaBox(clij, input, output, radius);
    }
