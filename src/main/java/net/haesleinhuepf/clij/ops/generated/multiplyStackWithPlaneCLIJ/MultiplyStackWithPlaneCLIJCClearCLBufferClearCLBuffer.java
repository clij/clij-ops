package net.haesleinhuepf.clij.ops.generated.multiplyStackWithPlaneCLIJ;
...
public class MultiplyStackWithPlaneCLIJCClearCLBufferClearCLBuffer
        extends
        AbstractUnaryComputerOp<ClearCLBuffer,ClearCLBuffer>
        implements MultiplyStackWithPlaneCLIJ, Contingent
{

    @Parameter
    private ClearCLBuffer input2d;
    ...
    public void compute(final ClearCLBuffer input, final ClearCLBuffer output)
    {
        final CLIJ clij = CLIJ.getInstance();
            ...
            Kernels.multiplyStackWithPlane(clij, input, input2d, output);
    }
