package net.haesleinhuepf.clij.ops.generated.maximumSphereCLIJ;
...
public class MaximumSphereCLIJCClearCLBufferClearCLBuffer
        extends
        AbstractUnaryComputerOp<ClearCLBuffer,ClearCLBuffer>
        implements MaximumSphereCLIJ, Contingent
{
    ...
    public void compute(final ClearCLBuffer input, final ClearCLBuffer output)
    {
        final CLIJ clij = CLIJ.getInstance();
            ...
            Kernels.maximumSphere(clij, input, output, kernelSizeX, kernelSizeY, kernelSizeZ);
    }
