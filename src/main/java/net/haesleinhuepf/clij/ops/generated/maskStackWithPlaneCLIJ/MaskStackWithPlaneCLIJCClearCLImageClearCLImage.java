...
public class MaskStackWithPlaneCLIJCClearCLImageClearCLImage
        extends
        AbstractUnaryComputerOp<ClearCLImage,ClearCLImage>
        implements MaskStackWithPlaneCLIJ, Contingent
{
    ...
    public void compute(final ClearCLImage input, final ClearCLImage output)
    {
        final CLIJ clij = CLIJ.getInstance();
            ...
            Kernels.maskStackWithPlane(clij, input, mask, output);
    }
