package net.haesleinhuepf.clij.ops.generated.minimumSphereCLIJ;
...
public class MinimumSphereCLIJCClearCLBufferClearCLBuffer
        extends
        AbstractUnaryComputerOp<ClearCLBuffer,ClearCLBuffer>
        implements MinimumSphereCLIJ, Contingent
{
    ...
    public void compute(final ClearCLBuffer input, final ClearCLBuffer output)
    {
        final CLIJ clij = CLIJ.getInstance();
            ...
            Kernels.minimumSphere(clij, input, output, kernelSizeX, kernelSizeY, kernelSizeZ);
    }
