package net.haesleinhuepf.clij.ops.generated.minimumImagesCLIJ;
...
public class MinimumImagesCLIJCClearCLBufferClearCLBufferClearCLBuffer
        extends
        AbstractBinaryComputerOp<ClearCLBuffer, ClearCLBuffer, ClearCLBuffer>
        implements MinimumImagesCLIJ, Contingent
{
    ...
    public void compute(final ClearCLBuffer input1, final ClearCLBuffer input2, final ClearCLBuffer output)
    {
        ...
        Kernels.minimumImages(clij, input1, input2, output);
    }
