package net.haesleinhuepf.clij.ops.generated.maximumOfAllPixelsCLIJ;
...
public class MaximumOfAllPixelsCLIJFClearCLImage
        extends
        AbstractUnaryFunctionOp<ClearCLImage, Double>
        implements MaximumOfAllPixelsCLIJ, Contingent
{
    ...
    public Double calculate(final ClearCLImage input)
    {
        final CLIJ clij = CLIJ.getInstance();
            ...
            return Kernels.maximumOfAllPixels(clij, input);
    }
