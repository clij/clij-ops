package net.haesleinhuepf.clij.ops.generated.resliceRightCLIJ;
...
public class ResliceRightCLIJCClearCLBufferClearCLBuffer
        extends
        AbstractUnaryComputerOp<ClearCLBuffer,ClearCLBuffer>
        implements ResliceRightCLIJ, Contingent
{
    ...
    public void compute(final ClearCLBuffer input, final ClearCLBuffer output)
    {
        final CLIJ clij = CLIJ.getInstance();
            ...
            Kernels.resliceRight(clij, input, output);
    }
