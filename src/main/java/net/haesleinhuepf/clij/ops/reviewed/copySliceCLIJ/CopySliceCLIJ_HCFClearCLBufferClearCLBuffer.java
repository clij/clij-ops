...
public class CopySliceCLIJ_HCFClearCLBufferClearCLBuffer
        extends
        ...
        implements CopySliceCLIJ, Contingent
{
    ...
    public ClearCLBuffer createOutput(ClearCLBuffer input) {
        ...
        if (input.getDimension() == 2) {
            return clij.createCLBuffer(new long[]{ input.getWidth(), input.getHeight(), planeIndex}, input.getNativeType());
        } else  {
