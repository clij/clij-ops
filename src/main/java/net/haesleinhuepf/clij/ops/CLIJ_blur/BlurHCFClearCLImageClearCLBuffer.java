...
public class BlurHCFClearCLImageClearCLBuffer extends
	AbstractUnaryHybridCF<ClearCLImage, ClearCLBuffer> implements CLIJ_blur,
	Contingent
{
	...
	public ClearCLBuffer createOutput(ClearCLImage input) {
		return clij.get().createCLBuffer(input.getDimensions(), null);
	}
